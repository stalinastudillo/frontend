 ...
 * T_FCTRCSDYLNTBO_817 - Productos 
 *
 */
@Path("/FCTRC/FRMLR/T_FCTRCSDYLNTBO_817")
@Component
@Service({T_FCTRCSDYLNTBO_817.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=FRMLR)(task.id=T_FCTRCSDYLNTBO_817)(task.version=1.0.0))")
,@Reference(name="VW_PRODUCTOSS_733", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_PRODUCTOSS_733)(view.version=1.0.0))")
...
public class T_FCTRCSDYLNTBO_817 {
