...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI7140_bli_eliminar_cliente")
})
public class BLI7140_bli_eliminar_cliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI7140_bli_eliminar_cliente.class);
