...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI7607_bli_crear")
})
public class BLI7607_bli_crear implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI7607_bli_crear.class);
