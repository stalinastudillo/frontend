...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI4116_bli_obtener_clientes")
})
public class BLI4116_bli_obtener_clientes implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI4116_bli_obtener_clientes.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapperSp1.addMapper(Cliente.CEDULA, 2);
      mapperSp1.addMapper(Cliente.NOMBRE, 3);
      mapperSp1.addMapper(Cliente.APELLIDO, 4);
      mapperSp1.addMapper(Cliente.DIRECCION, 5);
      mapperSp1.addMapper(Cliente.TELEFONO, 6);
