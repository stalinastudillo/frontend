...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI9087_bli_crear_cliente")
})
public class BLI9087_bli_crear_cliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI9087_bli_crear_cliente.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      String wcodigo = rowCliente.get(Cliente.CODIGO);
      ...
      if (logger.isDebugEnabled()) {
        logger.logDebug("inputParameters: " + " CODIGO: " + wcodigo + " CEDULA: " + wcedula + " NOMBRE: " + wnombre + " APELLIDO: " + wapellido + " DIRECCION: " + wdireccion + " TELEFONO: " + wtelefono);
      }
      ...
      if (wcodigo != null){
        mapper.addInputParameter("@i_cl_codigo", SqlType.INT, BLIUtils.convertToType(wcodigo, String.class));
      }
