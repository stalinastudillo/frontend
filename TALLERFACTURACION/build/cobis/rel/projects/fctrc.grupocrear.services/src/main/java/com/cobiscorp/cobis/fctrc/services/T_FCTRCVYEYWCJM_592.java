/*
 * Archivo: T_FCTRCVYEYWCJM_592.java
 * Fecha: 2021-10-18T01:18:36Z
 *
 ...
 * T_FCTRCVYEYWCJM_592 - MostrarProductos 
 *
 */
@Path("/FCTRC/FRMLR/T_FCTRCVYEYWCJM_592")
@Component
@Service({T_FCTRCVYEYWCJM_592.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=FRMLR)(task.id=T_FCTRCVYEYWCJM_592)(task.version=1.0.0))")
,@Reference(name="VW_MOSTRARPUT_570", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_MOSTRARPUT_570)(view.version=1.0.0))")
,@Reference (name="QV_QI85_UBK50",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_QI85_UBK50)")
,@Reference(name="Q_PRODTUUT_UU85",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_PRODTUUT_UU85)(query.version=1.0.0))")
...
public class T_FCTRCVYEYWCJM_592 {
