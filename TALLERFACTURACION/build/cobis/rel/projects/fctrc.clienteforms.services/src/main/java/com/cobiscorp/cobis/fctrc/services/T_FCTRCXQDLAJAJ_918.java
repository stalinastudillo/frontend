 ...
 * T_FCTRCXQDLAJAJ_918 - ClienteForm 
 *
 */
@Path("/FCTRC/FRMLR/T_FCTRCXQDLAJAJ_918")
@Component
@Service({T_FCTRCXQDLAJAJ_918.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=FCTRC)(task.submodule=FRMLR)(task.id=T_FCTRCXQDLAJAJ_918)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTEHYV_833", 
...
,@Reference(name="Q_CLIETNNT_OY67",
    ...
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIETNNT_OY67)(query.version=1.0.0))")
...
public class T_FCTRCXQDLAJAJ_918 {
