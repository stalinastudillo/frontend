...
public class ClienteQuery_QV_RL67_UZN75 implements IGridRowInserting {
	...
	@Reference(bind="setBLIInsertarCliente",
			...
			target = "(bli.id=BLI9087_bli_crear_cliente)")
	private IBLIExecutor BLIInsertarCliente;
	
	public void setBLIInsertarCliente(IBLIExecutor BLIInsertarCliente){
		this.BLIInsertarCliente = BLIInsertarCliente;
	}

	public void unsetBLIInsertarCliente(IBLIExecutor BLIInsertarCliente){
