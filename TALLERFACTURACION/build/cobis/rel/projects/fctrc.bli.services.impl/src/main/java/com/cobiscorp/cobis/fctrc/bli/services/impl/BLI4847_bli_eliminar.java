...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI4847_bli_eliminar")
})
public class BLI4847_bli_eliminar implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI4847_bli_eliminar.class);
