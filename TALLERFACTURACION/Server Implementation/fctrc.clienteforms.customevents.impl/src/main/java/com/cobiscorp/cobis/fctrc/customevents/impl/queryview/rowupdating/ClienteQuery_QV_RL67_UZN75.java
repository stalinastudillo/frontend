...
public class ClienteQuery_QV_RL67_UZN75 implements IGridRowUpdating {
	/**
	 * Instancia de Logger
	 */
	private static final ILogger logger = LogFactory.getLogger(ClienteQuery_QV_RL67_UZN75.class);
	
	@Reference(bind="setBLIUpdateCliente",
			unbind = "unsetBLIUpdateCliente",
			cardinality = ReferenceCardinality.MANDATORY_UNARY,
			target = "(bli.id=BLI7962_bli_actualizar_cliente)")
	private IBLIExecutor BLIUpdateCliente;
	
	public void setBLIUpdateCliente(IBLIExecutor BLIUpdateCliente){
		this.BLIUpdateCliente = BLIUpdateCliente;
	}

	public void unsetBLIUpdateCliente(IBLIExecutor BLIUpdateCliente){
		this.BLIUpdateCliente = null;
	}
	...
	public void rowAction(DataEntity arg0, IGridRowActionEventArgs arg1) {
		...
		try {
			...
			BLIUpdateCliente.execute(arg1.getDynamicRequest());
		} catch (Exception ex) {
